...
namespace HYDSWMAPI.Controllers
{
    ...
    public class MasterController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("GetAllCity")]
        public IActionResult GetAllCity(string IsAll)
        {
            ...
            string Result = _dataRepository.ExecuteQueryDynamicSqlParameter(StoredProcedureHelper.spGetAllCity, parameters);
            return Ok(Result);
        }

        [HttpGet]
        [Route("GetCityInfoById")]
        public IActionResult GetCityInfoById()
        {
           ...
           int CId = Convert.ToInt32(Request.Query["CId"]);
            ...
            string Result = _dataRepository.ExecuteQuerySingleDataTableDynamic(StoredProcedureHelper.spGetCityInfoById, parameters);
            return Ok(Result);
        }
        ...
        [HttpPost]
        [Route("GetAllZone")]
        public IActionResult GetAllZone(JObject obj)
        {
            ...
            SqlParameter[] parameters = new SqlParameter[]
              {
                  new SqlParameter("@ZCode",ZCode),
                  new SqlParameter("@IsAll",IsAll),
              };
            string _lst = _dataRepository.ExecuteQueryDynamicSqlParameter(StoredProcedureHelper.spGetAllZone, parameters);
        ...
        public IActionResult GetAllWard(JObject obj)
        {
            ...
            string ward = obj.GetValue("ward").Value<string>();
            SqlParameter[] parameters = new SqlParameter[]
            {
                  
                  
              };
            string _lst = _dataRepository.ExecuteQueryDynamicSqlParameter(StoredProcedureHelper.spGetAllWardFirst, parameters);
        ...
        [HttpPost]
        [Route("SelectCircleByWard")]
        public IActionResult SelectCircleByWard(JObject obj)
        {
            ...
            SqlParameter[] parameters = new SqlParameter[]
            {
                new SqlParameter("@WardId",ward)

              };
            string _lst = _dataRepository.ExecuteQueryDynamicSqlParameter(StoredProcedureHelper.SelectCircleByWard, parameters);
        ...
        [HttpPost]
        [Route("SelectZoneByWard")]
        public IActionResult SelectZoneByWard(JObject obj)
        {
            ...
            string _lst = _dataRepository.ExecuteQueryDynamicSqlParameter(StoredProcedureHelper.SelectZoneByWard, parameters);
        ...
        public IActionResult SaveAndUpdateZone(JObject obj)
        {
            ...
            string CId = obj.GetValue("CId").Value<string>();
        ...
        public IActionResult SaveAndUpdateCity(JObject obj)
        {
            int CId = obj.GetValue("CId").Value<int>();
            string CityNo = obj.GetValue("CityNo").Value<string>();
            string Citycode = obj.GetValue("Citycode").Value<string>();
            bool IsActive = obj.GetValue("IsActive").Value<bool>();
            string UserId = obj.GetValue("UserId").Value<string>();
            DateTime TDate = CommonHelper.IndianStandard(DateTime.UtcNow);
            SqlParameter[] parameters = new SqlParameter[]
              {
                  new SqlParameter("@CId",CId),
                  new SqlParameter("@CityNo",CityNo),
            ...
            string Result = _dataRepository.ExecuteQuerySingleDataTableDynamic(StoredProcedureHelper.spSaveAndUpdateCity, parameters);
            ...
            SqlParameter[] parameters = new SqlParameter[]
              {
                  ...
                  new SqlParameter("@CircleId",!string.IsNullOrEmpty(requestModel.CircleId)?requestModel.CircleId:"0"),
                  new SqlParameter("@WardId",!string.IsNullOrEmpty(requestModel.WardId)?requestModel.WardId:"0"),
                  new SqlParameter("@CityId",!string.IsNullOrEmpty(requestModel.CityId)?requestModel.WardId:"0"),
              };
            string _lst = _dataRepository.ExecuteQueryDynamicSqlParameter(StoredProcedureHelper.spGetAllTransferStation_Paging, parameters);
